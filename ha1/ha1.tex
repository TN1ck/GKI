...
\begin{enumerate}[~~a)]
    ...
    Ein Stapel hat die Struktur (a, S) oder (a, L). Wobei 'a' die oberste Kiste ist, S der restliche Stapel und L der Leere Stapel. Leere Stapel in Z werden nicht ausgeschrieben, es befinden sich aber von Anfang  ausreichend (4) in der Menge.\\
    \textbf{Anfangszustand:} \\
    ${(5, (3, (4, (1, (2, L)))))}$ \\
    \textbf{Zielzustand:} \\
    ${(1, (2, (3, (4, (5, L)))))}$ \\     
