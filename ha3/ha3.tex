...
\end{align*}
In Mengenschreibweise mit umbenannten Variablen:
\begin{align*}
\{\{\lnot Be(x, GKI), \lnot Ge(x,Poker) , Fr(x) \} , \{\lnot Fl(a), Be(a,b)\}, \{ \lnot In(c), Be(c,d)\} ,\\ \{\lnot Be(e,g), Te(e,f(e,g))\},\{\lnot In(h), Ge(h, Poker)\}, \{\lnot Fl(O)\}, \{In(O)\}, \{Fl(S)\}, \{\lnot In(S)\}\}
\end{align*}
    \item
